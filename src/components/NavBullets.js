...
const NavBullets = () => {
    ...
    return (
        <>
            <Bullets>
                <NavLink to="/rewards/personal-rewards"><span>Personal rewards</span></NavLink>
                <NavLink to="/rewards/group-rewards"><span>Group rewards</span></NavLink>
                <NavLink to="/rewards/competition-rewards"><span>Competition</span></NavLink>
                <NavLink to="/rewards/social-engagement"><span>Social engagement</span></NavLink>
                <NavLink to="/rewards/referral-program"><span>Referral Program</span></NavLink>
