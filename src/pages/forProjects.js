                ...
                <div className='background'>
                    ...
                    <MainContainer>
                        <Container className="pt-10">
                            <div className='mt-14'>
                                <div className='font-play text-white-main text-9 md:text-1 text-center'>For projects</div>
                                <div className='text-center font-montserrat mt-2'>
                                    <p className='text-white-2 text-8 mt-7 leading-8'>Projects that use any of Qonetum Finance solutions, are eligible to conduct an AMA in the  Qonetum Finance community relevant to the use case and solution. Qonetum Finance does not charge for the exposure, instead, the project conducting the AMA rewards AMA participants with tokens equal to $5,000 value. Projects that conduct an AMA can explain their project concept to potentially a new group of users and investors. </p>
                                    <button class="btn-golden shadow-lg mt-12 w-[660px] h-[80px] bg-yellow-main border-2 border-solid bg-opacity-0 text-slate-50 font-bold text-xl uppercase ">APPLY NOW</button>
                                </div>
                            </div>
                        </Container>
                    </MainContainer>
