                        ...
                        <TabPanel>
                            <StepSec>
                                ...
                                <IFrameCol><img src={iframe1}></img>
                                    <button className="btn-golden shadow-lg w-[660px] h-[80px] mt-6 bg-yellow-main border-2 border-solid bg-opacity-0 text-white-1 font-bold text-xl uppercase">
                            ...
                            <StepSec>
                                <div className="">
                                    <div className="flex items-center">
                                        ...
                                        <h2 className="font-play text-white-main text-9 md:text-3xl	 ml-8">Individual testing</h2>
                                    </div>
                            ...
                            <StepSec>
                                <div className="">
                                    <div className="flex items-center">
                                        ...
                                        <h2 className="font-play text-white-main text-9 md:text-3xl	 ml-8">Issue finding </h2>
                                    </div>
                            ...
                            <StepSec>
                                <div className="">
                                    <div className="flex items-center">
                                        ...
                                        <h2 className="font-play text-white-main text-9 md:text-3xl	 ml-8">Learn and earn </h2>
                                    </div>
                            ...
                            <StepSec>
                                <div className="">
                                    <div className="flex items-center">
                                        ...
                                        <h2 className="font-play text-white-main text-9 md:text-3xl	 ml-8">affiliate program</h2>
                                    </div>
                                    ...
                                    <div className="flex mx-auto center flex-col items-center ">
                                        <div className={`flex flex-col ${this.state.shown ? 'hidden' : ''}`}>
                                            <input type="text" name="" className="px-6 w-[660px] h-[80px] bg-transparent border-2 border-white-3 text-xl" placeholder="pdo.finance/123n21n2382aAG39"></input>
                                            <button className="btn-golden shadow-lg w-[660px] h-[80px] mt-6 bg-yellow-main border-2 border-solid bg-opacity-0 text-slate-50 font-bold text-xl uppercase mb-1">Copy</button>
                                        </div>
                                        <button className={`btn-golden shadow-lg w-[660px] h-[80px] mt-6 bg-yellow-main border-2 border-solid bg-opacity-0 text-slate-50 font-bold text-xl uppercase mb-1 ${this.state.shown ? '' : 'hidden'}`} onClick={() => this.setState({ shown: !this.state.shown })}>CONNECT YOUR WALLET TO BECOME AN AFFILIATE</button>
