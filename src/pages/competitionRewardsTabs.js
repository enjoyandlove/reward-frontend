                    ...
                    <Tabs>
                        <StepNav>
                            <TabList className="mt--10">
                                <Tab className='wow flipInY'><span>Personal Trading competition</span></Tab>
                                <Tab className='wow flipInY'><span>Personal Staking competition</span></Tab>
                                <Tab className='wow flipInY'><span>Group trading competition</span></Tab>
                                <Tab className='wow flipInY'><span>Group staking competition</span></Tab>
                            </TabList>
                        </StepNav>
