    ...
    <>
      <Container>
        <BreadCrumbs>
          ...
          <BreadLinks href="/rewards/trading-rewards">Trading rewards</BreadLinks>
        </BreadCrumbs>
        <div class="font-play text-white-main text-9 md:text-1 text-center" data-wow-delay="0.1s">choose a project for trading reward</div>
        <ChooseProject>
          <ProjectItems onClick={() => { navigate('/rewards/trading-rewards-pdo') }} className="wow zoomIn"><img src={project1}></img></ProjectItems>
