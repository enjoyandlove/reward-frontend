  ...
  return (
    <>
      <Container>
        ...
        <div class="font-play text-white-main text-9 md:text-1 text-center" data-wow-delay="0.1s">choose a project for Referral Program</div>
        <ChooseProject>
          <ProjectItems onClick={() => { navigate('/rewards/referral-program-pdo') }} className="wow zoomIn"><img src={project1}></img></ProjectItems>
