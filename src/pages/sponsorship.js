                ...
                <div className='background'>
                    ...
                    <MainContainer>
                        <Container className="pt-10">
                            <div className='mt-14'>
                                <div className='font-play text-white-main text-9 md:text-1 text-center'>apply for sponsorship</div>
                                <div className='text-center font-montserrat mt-2'>
                                    <p className='text-white-2 text-8 mt-7 leading-8'>Running event and need a sponsorship to increase awareness and participants? Apply for dVocuher awards</p>
                                    ...
                                    <button class="btn-golden shadow-lg mt-10 w-[660px] h-[80px] bg-yellow-main border-2 border-solid bg-opacity-0 text-slate-50 font-bold text-xl uppercase ">APPLY FOR SPONSORSHIP</button>
                                </div>
                            </div>
                        </Container>
                    </MainContainer>
