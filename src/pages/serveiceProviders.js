                ...
                <div className='background'>
                    ...
                    <MainContainer>
                        <Container className="pt-10">
                            <div className='mt-14 wow fadeInDown' data-wow-delay="0.1s">
                            ...
                            <div className="font-play text-white-main text-9 md:text-4xl text-center mb-12 wow fadeInUp" data-wow-delay="0.5s">COntact us</div>
                            <Form className="text-white-main">
                                <div className="grid md:grid-cols-3 items-end">
                                    <div className="px-4 mb-5 wow fadeInUp" data-wow-delay="0.6s">
                                        <label className="text-lg font-bold mb-3 block">Full name</label>
                                        <input type="text" className="px-3 ms:px-6 text-lg w-full h-[50px] md:h-[67px] bg-black border-2 border-current border-zinc-900 text-left flex items-center"></input>
                                    </div>
                                    <div className="px-4 mb-5 wow fadeInUp" data-wow-delay="0.7s"> 
                                        <label className="text-lg font-bold mb-3 block">Email</label>
                                        <input type="text" className="px-3 ms:px-6 text-lg w-full h-[50px] md:h-[67px] bg-black border-2 border-current border-zinc-900 text-left flex items-center"></input>
                                    </div>
                                    <div className="px-4 mb-5 wow fadeInUp" data-wow-delay="0.8s"> 
